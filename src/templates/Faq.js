...
const Faq = () => {
    return ( 
        <div className="div__faqcentered">
        ...
        <section>
            <h5 className="h5__headlineFaq">shipping</h5>
            <p className="p__shippingSplit">To return your product, you should mail your product to: 2 Joppa Road, Mackenzie House, Edinburgh, EH15 2EU.</p>
            <p className="faq__spaceTop">If you would like to return an item, please note that we cannot arrange a collection of the item without additional cost; you will be responsible for ensuring the product reaches us. Shipping costs are non-refundable. If you receive a refund, the cost of return shipping will be deducted from your refund. Depending on where you live, the time it may take for your exchanged product to reach you may vary. We will process the refund when the item arrives with us.</p>
            <p className="faq__spaceTop">If you are shipping an item over £100, we would advise using a trackable shipping service or purchasing shipping insurance. We cannot guarantee that we will receive your returned item.</p>
        </section>

        <section>
            <h5 className="h5__headlineFaq">delivery</h5>
            <p>Please check the condition of all products delivered as soon as they are received. This does not affect your statutory rights. If there is a problem we would like to deal with this as soon as possible to alleviate any inconvenience to yourself.</p>
        ...
        <section>
            <h5 className="h5__headlineFaq">exchanges</h5>
            <p className="faq__h5Split">We can only replace items if they are defective or damaged. If you need to exchange the product for the same item due to a fault, please first send us an email at sales@hificorner.co.uk and once approved, send your item to:</p>
            <p className="faq__h5Split">Hi-Fi Corner, 2 Joppa Road, Mackenzie House, Portobello, Edinburgh, EH15 2EU.</p>
            <p className="faq__h5Split">Please also include the proof of purchase and a cover letter detailing the reason for exchange.</p>
        </section>
